        ...
        public class Chain
        {
            ...
            private List<Segment> BuildSegments(string classname, List<string> chain)
            {
                ...
                foreach (var linkString in chain)
                {
                    ...
                    var matchingFhirElements = baseType.FindMembers(MemberTypes.Property,
                        BindingFlags.Instance | BindingFlags.Public, IsFhirElement, segment.Name);
            ...
            public void Visit(object field, Action<object> action)
            {
                Visit(field, segments, action, null);
            }
            ...
            private void Visit(object field, IEnumerable<Segment> chain, Action<object> action,
                ...
                else //single value
                {
                    ...
                    if (predicate == null || predicate(field))
                        ...
                        ) //not at the end of the chain, follow the next link in the chain
                        {
                            ...
                            if (subfield != null && next != null && next.Property != null &&
                                (next.AllowedType == null || next.AllowedType.IsAssignableFrom(subfield.GetType())))
