...
namespace FhirOnAzure.Search.Support
{
    ...
    internal static class Error
    {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "Utility method that might become useful for future usecases")]
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "Utility method that might become useful for future usecases")]
        internal static ArgumentNullException ArgumentNull(string parameterName, string messageFormat,
            params object[] messageArgs)
        {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "Utility method that might become useful for future usecases")]
        internal static InvalidOperationException InvalidOperation(Exception innerException, string messageFormat,
            params object[] messageArgs)
        {
