...
namespace FhirOnAzure.Search.Support
{
    ...
    internal static class ReflectionHelper
    {
        ...
        public static Type GetCollectionItemType(Type type)
        {
            ...
            if (ImplementsGenericDefinition(type, typeof(ICollection<>), out genericListType))
            {
            ...
            out Type implementingType)
        {
            ...
            if (!genericInterfaceDefinition.IsInterface || !genericInterfaceDefinition.IsGenericTypeDefinition)
                throw Error.Argument("genericInterfaceDefinition", "'{0}' is not a generic interface definition.",
