...
namespace FhirOnAzure.Search
{
    ...
    public class Criterium : Expression, ICloneable
    {
        ...
        private static readonly List<Tuple<string, Operator>> operatorMapping = new List<Tuple<string, Operator>>
        {
            ...
            new Tuple<string, Operator>("IN",
                Operator.IN) //This operator is not allowed on the REST interface: IN(a,b,c) should be formatted as =a,b,c. It is added to allow reporting on criteria.
        };
