...
using FhirOnAzure.Engine.Auxiliary;

namespace FhirOnAzure.Service
{
    /// <summary>
    /// Import can map id's and references  that are local to the FhirOnAzure Server to absolute id's and references in outgoing Interactions.
    /// </summary>
